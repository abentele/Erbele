...
- (NSString *)genererateTemporaryPath
{
	...
	do {
		sequenceNumber++;
		temporaryPath = [NSString stringWithFormat:@"%d-%ld-%ld.%@", [[NSProcessInfo processInfo] processIdentifier], (NSInteger)[NSDate timeIntervalSinceReferenceDate], sequenceNumber, @"Erbele"];
